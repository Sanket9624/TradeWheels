...
router.get('/cars', authMiddleware.authenticateToken, sellCarController.getAllCars);
router.get('/cars/:id', authMiddleware.authenticateToken, sellCarController.getCarById); 
